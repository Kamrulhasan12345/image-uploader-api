...
class App extends router.Router {
    ...
    find(url, method) {
        return this.middleware.filter((m) => {
            m.regex = m.type === 'mw' ? rg__default['default'](m.path, true) : rg__default['default'](m.path);
    ...
    handler(req$1, res, next) {
        ...
        const mw = [
            ...
            ...this.find(pathname, req$1.method),
            {
        ...
        const handle = (mw) => async (req$1, res, next) => {
            ...
            if (type === 'route')
                req$1.params = req.getURLParams(regex, pathname);
